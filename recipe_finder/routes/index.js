...
function deleteRecipe(req, res, next)
{
    if (req.body.user_id == req.body.recipe_user_id)
    {
        con.query(("DELETE FROM comments WHERE recipe_id ="+req.body.recipe_id+"; \n"+
                    "DELETE FROM recipes_ingredients WHERE recipe_id ="+req.body.recipe_id+"; \n"+
                    "DELETE FROM Recipe WHERE recipe_id ="+req.body.recipe_id+";"), function (err, rows, fields) {
          if (err) throw err
        });
    }
    return next();
